...
<style>
  ...
  #bN015htcoyT__google-cache-hdr a {
  ...
  #bN015htcoyT__google-cache-hdr a:hover {
  ...
  #bN015htcoyT__google-cache-hdr a:visited {
  ...
  #bN015htcoyT__google-cache-hdr div {
  ...
  #bN015htcoyT__google-cache-hdr b {
...
<div style="position:relative;">
  ...
  <head>
    ...
    <link rel="icon" href="https://https://www.genexinfosys.com/images/favicon.ico" sizes="32x32" />
    <link rel="icon" href="https://https://www.genexinfosys.com/images/favicon.ico" sizes="192x192" />
    <link rel="apple-touch-icon" href="https://https://www.genexinfosys.com/images/favicon.ico" />
    <meta name="msapplication-TileImage" content="https://https://www.genexinfosys.com/images/favicon.ico" />

    <link href="https://https://www.genexinfosys.com/images/favicon.ico?v=2" rel="icon" type="image/x-icon" />
    <link rel="shortcut icon" href="https://https://www.genexinfosys.com/images/favicon.ico" sizes="48x48" />
    ...
    <nav class="navbar navbar-default" role="navigation" style="background-color: #fff !important">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <!-- <li class="dropdown"><a href="services.php">What We Do</a><div class="dropdown-content"><a href="outsourcing.php">Outsourcing</a><a href="solutions.php">Technology</a><a href="expertise.php">Expertise</a><a href="verticals.php">Verticals</a></div></li> -->
            ...
            <div class="dropdown-content custom">
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  ...
                  <span class="menu-sub-titile"> Customer Experience Management </span>
                ...
                <div class="col-md-3">
                  ...
                  <span class="menu-sub-titile"> Back-Office Management </span>
                ...
                <div class="col-md-3">
                  ...
                  <span class="menu-sub-titile"> Digital Transformation & Solutions </span>
                ...
                <!-- <div class="col-md-1"><span class="menu-sub-titile"> Digital Marketing </span><hr class="custom-hr"><a href="../digital-marketing.php">Digital Marketing </a><a href="../digital-marketing.php">Ad Network</a><a href="../digital-marketing.php">Digital Content Development</a></div> -->

                <div class="col-md-3">

                  <span class="menu-sub-titile"> Training & Skill Development </span>
...
<div id="myCarousel" class="carousel slide hidden" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="item active">
      ...
      <img src="images/cover/Customer exp.jpg?v=1576671563" alt="Los Angeles" style="width:100%;">
    ...
    <div class="item">
      ...
      <img src="images/cover/Emerging Technologies.jpg?v=1576671557" alt="Chicago" style="width:100%;">

      <div class="carousel-caption">

        <h2>Drive Excellence </span>
    ...
    <div class="item">
      ...
      <img src="images/cover/Reengineer Your Business.jpg?v=1576671576" alt="New York" style="width:100%;">
  ...
  <div id="myCarousel" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        ...
        <img src="images/cover/11.jpg?v=1512499766" alt="" />
      ...
      <div class="item ">
        ...
        <img src="images/cover/10.jpg?v=1512499839" alt="" />
      ...
      <div class="item ">
        ...
        <img src="images/cover/12.jpg?v=1512499838" alt="" />
...
<div class="container hidden">
  ...
  <div class="row">
    ...
    <div class="col-md-12 text-center" style="padding-top: 100px; color: #555; padding-bottom: 10px">

      <img src="images/icon/ipo.png" alt="">

      <h1>1st publicly listed ITeS Bangladesh Co</h1>
...
<div class="services">
  ...
  <div class="col-md-12 text-center content">
    ...
    <div class="container">
      ...
      <h1>It’s not just about being big, it’s about accomplishment</h1>

      <!-- <h1>Serving Millions</h1> -->

      <!-- <h4>It’s not just about being big, it’s about accomplishment</h4> -->
...
<div class="row">
  ...
  <div class="content">
    ...
    <div class="col-md-12 static-info" style="padding-top: 0px; padding-bottom: 50px;">

      <div class="col-md-2 col-md-offset-1 col-xs-12">

        <img src="images/icon/home page icon/Publicly-listed-company-icon.png" alt="" />

        <p style="font-size:16px;">1st Publicly Listed</p>

        <p style="font-size:16px;">BPO & ITeS Company</p>

        <p style="font-size:16px;">In Bangladesh</p>

      </div>

      <div class="col-md-2 col-xs-12">

        <img src="images/icon/home page icon/genex-icon-3000+-people.jpg" alt="" />

        <p style="font-size:16px;">

          <span>Strong Team of</span>

        </p>

        <p style="font-size:16px;">4000+ People</p>

      </div>

      <div class="col-md-2 col-xs-12">

        <img src="images/icon/home page icon/xicon2.png" alt="" />

        <p style="font-size:16px;">

          <span>170 Million</span>+

        </p>

        <p style="font-size:16px;">Customer Interactions</p>

        <p style="font-size:16px;">Managed Per Year</p>

      </div>

      <div class="col-md-2 col-xs-12">

        <img src="images/icon/home page icon/genex-icon-Centers-across-Asia.jpg" alt="" />
        ...
        <p style="font-size:16px;"> Centers Across</p>

        <p style="font-size:16px;"> South-East Asia</p>

      </div>

      <div class="col-md-2 col-xs-12">

        <img src="images/icon/home page icon/Genex-infosys-and-solution-brochure-2019.png" alt="" />

        <p style="font-size:16px;">

          <span>130+ Global</span>

        </p>

        <p style="font-size:16px;">Tech Partnerships</p>
...
<div class="row services bodybg hidden">

  <div class="col-md-12 text-center content">

    <h1>360 Degree Customer Experience Management</h1>

    <h4>Our partners are important and their customers too. </h4>

  </div>

</div>

<div class="row content hidden" style="background-color:#f1f2f3;">

  <div class="thum col-md-4 noPadding">

    <div class="blue-thum thums">

      <p style="font-size:28px;color:white;">Outsourcing</p>
      ...
      <p style="color:white; padding: 0px 30px 0px 30px;;">With the latest technology embedded, competent staffs and optimized service, Genex has successfully launched solutions that’s popular globally. </p>
  ...
  <div class="thum col-md-4 noPadding">
    ...
    <div class="yellow-thum thums">

      <p style="font-size:28px;color:white;">Technology</p>
      ...
      <p style="color:white;padding: 0px 30px 0px 30px; border-radius: 2px;">Office management to leads management, Genex provides a 360 degree solution systems that optimizes performance and ROI.</p>
  ...
  <div class="thum col-md-4 noPadding">
    ...
    <div class="purple-thum thums">

      <p style="font-size:28px; ">Expertise</p>
      ...
      <p style="padding: 0px 30px 0px 30px;">Dynamic, adaptable and young, these industry leaders offer tailored systems for the existing and enormous clientele, locally and globally. </p>
...
<div class="row">
  ...
  <div class="InfaPageCover">

    <div class="text-center">

      <img src="images/icon/it-infrastructure-active-directory-icon.png" style="width: 80px;" alt="" />

      <h1>Great Infrastructure</h1>

      <h4>State of art infrastructure, complying all the pre-requisites to operate, with an added flavour of comfort, ease and feel at home.</h4>
...
<div class="row services">
  ...
  <div class="col-md-12 text-center content ">
    ...
    <div class="res-content">
      ...
      <h4>Goals in mind, this is an utmost empowering culture, where we are responsible for our performance and love challenging ourselves.</h4>
...
<div class="row">
  ...
  <div class=" col-md-12 content cultureContent">
    ...
    <div class="culture">
      ...
      <div class="cultureContent">
        ...
        <div class="cultureBottomContent" style="margin-top: 369px;">

          <p>Together we Drive towards Excellence</p>

          <a href="position.php">

            <button type="button" class="joinButton">Join Us</button>
    ...
    <div class="col-md-10 content">
      ...
      <div class="col-md-4 col-sm-6 noPadding">
        ...
        <div class="socialFeed">
          ...
          <h2>News <span style="color: #26bfb8;">Room</span>
          ...
          <div>
            ...
            <p>
              ...
              <br /> The 10-year deal to help the National Board of Revenue boost its VAT collection countrywide is likely the biggest one, finalised last month. It requires Genex Infosys to install electronic devices and sales data controllers at the company's own expense of Tk 10 billion.

            </p>

            </br>

            <a href="news.php" style="color:#26bfb8">Read More >></a>
      ...
      <div class="col-md-4 col-sm-6 noPadding">
        ...
        <div class="socialFeed">
          ...
          <h2>Awards and <span style="color: #26bfb8;">Recognition</span>

          </h2>

          <div>

            <div class="cycle-slideshow" data-cycle-fx="scrollHorz" data-cycle-timeout="4000" data-cycle-slides=">div" style="width: 100%">

              <div style="width: 100%" class="horizontalSlider">

                <img src="https://tds-images.thedailystar.net/sites/default/files/styles/big_202/public/images/2022/03/23/genx-wb.jpg?itok=5GOLYb0y&timestamp=1648030812" style="width: 100%;" alt="" />

                <h3>Genex Infosys wins ‘BASIS Luna Shamsuddoha Award’</h3>

                <hr>

                <p>Genex Infosys, a business process management (BPM) and IT services company, has been awarded 'BASIS Luna Shamsuddoha Award 2022' for employing the highest number of women in this sector. <br>

                  <br> Parliament Speaker Shirin Sharmin Chaudhury distributed the award at a ceremony at Radisson Blu Dhaka Water Garden on March 20, said a press release.

                </p>

                </br>

                <a href="awards.php" style="color:#26bfb8">Read More >></a>
      ...
      <div class="col-md-4 col-sm-6 noPadding">
        ...
        <div class="socialFeed">
          ...
          <h2>Facebook <span style="color: #26bfb8;">Feed</span>

          </h2>

          <div>

            <div class="fb-page" data-href="https://www.facebook.com/genexinfosys" data-tabs="timeline" data-height="600" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">

              <blockquote cite="https://www.facebook.com/genexinfosys" class="fb-xfbml-parse-ignore">

                <a href="https://www.facebook.com/genexinfosys">Genex Infosys</a>
...
<!-- <div id="feedback"><a href="http://genex.com.bd/demo/"><i class="fa fa-home fa-3x" aria-hidden="true"></i></a></div> -->
...
<div class="row footer">
  ...
  <div class="col-md-12 f-top no-padding">
    ...
    <div class="col-md-2 col-sm-6 no-padding">
      ...
      <!--<a href="<?php echo $base_url ?>/investor-relations.php">Investor Relations</a>-->
    ...
    <div class="col-md-3 col-sm-6 no-padding">
      ...
      <div class="footer-top-social">
        ...
        <ul>
          ...
          <a href="https://www.facebook.com/genexinfosys">
            <li class="fb"><span></span></li>
          </a>

          <a href="https://www.linkedin.com/company/genex-infosys-limited">
            <li class="linkedIn"><span></span></li>
          </a>

          <a href="https://twitter.com/genexinfosys?lang=en">
            <li class="twitter"><span></span></li>
          </a>

          <a href="https://www.instagram.com/genexinfosys/">
    ...
    <div class="col-md-4 col-sm-6 no-padding">
      ...
      <span style="color: #3a3d3b; font-weight: 400"><b>Service Delivery Centers</b><br />
        ...
        <li>Nitol Niloy Tower (Level 6-12), Nikunja C/A, Airport Road, Dhaka-1229</li>
        </li>
  ...
  <div class="col-md-12 fixed-bottom no-padding">
    ...
    <div class="col-md-7">
      ...
      <div class="col-md-7 col-sm-12 footerLogo text-center">
        ...
        <img src="images/genex.jpg?v=1512503869" class="img-responsive" alt="" />

        <p>Copyright © 2015-2022 • Genex • All Rights Reserved</p>

      </div>

      <!-- <div class="col-md-5"><a href="https://www.hitwebcounter.com" target="_blank"><img src="https://hitwebcounter.com/counter/counter.php?page=7172720&style=0006&nbdigits=7&type=page&initCount=0" title="Counter" Alt="hit web counter.com" border="0" ></a></div> -->
...
<script type="text/javascript" src="main.min.js?v=1512500792"></script>
